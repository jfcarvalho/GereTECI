...
CREATE TABLE `licenca` (
  ...
  KEY `fk_licenca_usuario1_idx` (`usuario_id_usuario`),
  CONSTRAINT `fk_licenca_usuario1` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
