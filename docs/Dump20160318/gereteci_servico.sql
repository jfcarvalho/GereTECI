...
CREATE TABLE `servico` (
  ...
  `descricao_problema` varchar(100) DEFAULT NULL,
  `status` varchar(50) DEFAULT NULL,
  `descricao_pronta` varchar(100) DEFAULT NULL,
  ...
  `servico_manutencao` int(11) DEFAULT NULL,
  ...
  KEY `FK_qvbtvybvr2pu8oo5i0ewbstsa` (`servico_manutencao`),
  ...
  CONSTRAINT `FK_qvbtvybvr2pu8oo5i0ewbstsa` FOREIGN KEY (`servico_manutencao`) REFERENCES `usuario` (`id_usuario`)
...
INSERT INTO `servico` VALUES (19,'Manutenção','2016-03-18 00:00:00','sssaaaasssaaaa','em_andamento','desc2',2,'2016-03-18 00:00:00','ssssaaaassssaaa','666','\0','\0',1,NULL,'kakakjssgs','slsslskshsgs');
