...
CREATE TABLE `licenca` (
  ...
  KEY `FK_rgjpfr7f73ac0fqy8ba1g7dqf` (`computador_id_computador`),
  CONSTRAINT `FK_rgjpfr7f73ac0fqy8ba1g7dqf` FOREIGN KEY (`computador_id_computador`) REFERENCES `computador` (`id_computador`)
